		...
		<div class="user-content">
			...
			<div class="users-socials">
				...
				<?php if (!empty($user->linkedin)) { ?>
					<a href="<?php echo esc_attr($user->linkedin); ?>" target="_blank" rel="nofollow"><i class="fab fa-instagram"></i></a>
				<?php } ?>
				<?php if (!empty($user->instagram)) { ?>
					<a href="<?php echo esc_attr($user->instagram); ?>" target="_blank" rel="nofollow"><i class="fab fa-linkedin"></i></a>
				<?php } ?>
		  	</div>
