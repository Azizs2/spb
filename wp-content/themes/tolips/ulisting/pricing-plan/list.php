...
<?php if ( $plans ):?>
	...
	<div class="stm-row">
		<?php foreach ($plans as $plan):?>
			...
			?>
			<div class="stm-col-12 stm-col-md-4 text-center">
				<div class="listing-pricing-plan-content">
					<div class="card">
						<div class="card-body">
							...
							<a class="btn btn-default btn-pricing" href="<?php echo StmPricingPlans::get_page_url()?>?buy=<?php echo esc_attr($plan->ID)?>">Buy Package</a>
						</div>
					</div>
				</div>		
			</div>
