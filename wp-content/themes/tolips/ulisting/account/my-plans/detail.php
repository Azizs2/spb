...
<div id="user-plan-detail">
	...
	<div class="dashboard-content-inner">
		<div class="stm-row">
			<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Plan', 'tolips') ?>: </label></div>
			<div class="stm-col-xl-9 stm-col-lg-9 stm-col-12"><?php echo esc_html($plan->post_title)?></div>
		</div>
		<div class="stm-row">
			<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Status', 'tolips') ?>: </label></div>
			<div class="stm-col-xl-9 stm-col-lg-9 stm-col-12"><?php echo \uListing\Lib\PricingPlan\Classes\StmUserPlan::getStatus($user_plan->status)?></div>
		</div>
		<?php if($user_plan->payment_type !== \uListing\Lib\PricingPlan\Classes\StmPricingPlans::PRICING_PLANS_PAYMENT_TYPE_SUBSCRIPTION): ?>
			 <div class="stm-row">
				  <div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Type', 'tolips') ?>: </label></div>
				  <div class="stm-col-xl-9 stm-col-lg-9 stm-col-12"><?php echo \uListing\Lib\PricingPlan\Classes\StmPricingPlans::pricingPlansTypeListData($user_plan->type)?></div>
			 </div>
		<?php endif;?>

		<div class="stm-row">
			<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Payment type', 'tolips') ?>: </label></div>
			<div class="stm-col-xl-9 stm-col-lg-9 stm-col-12"><?php echo \uListing\Lib\PricingPlan\Classes\StmPricingPlans::pricingPaymentTypeListData($user_plan->payment_type)?></div>
		</div>

		<?php if($user_plan->payment_type == \uListing\Lib\PricingPlan\Classes\StmPricingPlans::PRICING_PLANS_PAYMENT_TYPE_SUBSCRIPTION): ?>
			<div class="stm-row">
				<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Expired date', 'tolips') ?>: </label></div>
				<div class="stm-col-xl-9 stm-col-lg-9 stm-col-12">
		...
		<div class="stm-row">
			<div class="stm-col-xl-3 stm-col-lg-3 stm-col-12"><label><?php echo esc_html__('Created date', 'tolips') ?>: </label></div>
			<div class="stm-col-xl-9 stm-col-lg-9 stm-col-12">
		...
		<?php if($user_plan->payment_type == \uListing\Lib\PricingPlan\Classes\StmPricingPlans::PRICING_PLANS_PAYMENT_TYPE_SUBSCRIPTION): ?>
			<?php if( (
				...
				<div class="panel-custom p-t-30 p-b-30">
					...
					<button class="btn btn-danger" v-if="!loading" @click="user_plan_cancel"><?php echo esc_html__("Cancel", "tolips")?></button>
				</div>
