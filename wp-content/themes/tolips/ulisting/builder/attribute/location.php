...
$element['params']['class'] = 'ulisting-location';
?>
	...
	<?php else:?>
		...
		<div class="stm-row">
			<div class="stm-col-12 stm-col-md-6">
				<h3 class="ulisting-el-heading"><?php echo esc_html($element['title']);?></h3>
			</div>
			<div class="stm-col-12 stm-col-md-6 location-address">
