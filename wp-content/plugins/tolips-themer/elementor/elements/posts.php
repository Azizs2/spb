...
class GVAElement_Posts extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Posts', 'tolips-themer');
    }
    ...
    private function get_categories_list(){
        ...
        $categories['none'] = __( 'None', 'tolips-themer' );
        $taxonomy = 'category';
    ...
    private function get_posts() {
        ...
        $posts['none'] = __('None', 'tolips-themer');
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => __('Query & Layout', 'tolips-themer'),
         ...
         $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'small_list'    => __( 'Small List', 'tolips-themer' )
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'post-style-1'         => __( 'Item Post Style I', 'tolips-themer' ),
                    'post-style-2'         => __( 'Item Post Style II', 'tolips-themer' ),
                    'post-style-3'         => __( 'Item Post Style III', 'tolips-themer' ),
                ],
                'condition' => [
        ...
        $this->add_control(
            'image_size',
            [
               'label'     => __('Image Style', 'tolips-themer'),
               'type'      => \Elementor\Controls_Manager::SELECT,
        ...
        $this->add_control(
            'category_ids',
            [
                'label' => __( 'Select By Category', 'tolips-themer' ),
        ...
        $this->add_control(
            'post_ids',
            [
                'label' => __( 'Select Individually', 'tolips-themer' ),
                'type' => Controls_Manager::SELECT2,
                'default' => '',
                'multiple'    => true,
                'label_block' => true,
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __( 'Posts Per Page', 'tolips-themer' ),
        ...
        $this->add_control(
            'orderby',
            [
                'label'   => __( 'Order By', 'tolips-themer' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'post_date',
                'options' => [
                    'post_date'  => __( 'Date', 'tolips-themer' ),
                    'post_title' => __( 'Title', 'tolips-themer' ),
                    'menu_order' => __( 'Menu Order', 'tolips-themer' ),
                    'rand'       => __( 'Random', 'tolips-themer' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'order',
            [
                'label'   => __( 'Order', 'tolips-themer' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'desc',
                'options' => [
                    'asc'  => __( 'ASC', 'tolips-themer' ),
                    'desc' => __( 'DESC', 'tolips-themer' ),
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Right List Posts Style', 'tolips-themer' ),
        ...
        $this->add_responsive_control(
            'stick_list_padding',
            [
                'label' => __( 'Padding List Posts', 'tolips-themer' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background List Posts', 'tolips-themer' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Title Color', 'tolips-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Meta Color', 'tolips-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Content', 'tolips-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_responsive_control(
            'post_box_padding',
            [
                'label' => __( 'Padding Post Content', 'tolips-themer' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
        ...
        $this->add_control(
            'post_box_background',
            [
                'label' => __( 'Background Post Content', 'tolips-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Title', 'tolips-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['grid', 'carousel']
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Color Title', 'tolips-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Color Title Hover', 'tolips-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Description', 'tolips-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['grid', 'carousel']
                ],
